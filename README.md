...
- Initialize input values.
  ...
  $$h:$$ Hinge leaf height.<br>

  $$r:$$ Knuckle radius is equal to the leaf gauge.<br>

  $$s = w \space + \space r \quad$$ Cartesian position of the point where the gusset curve merges with the leaf. <br>
