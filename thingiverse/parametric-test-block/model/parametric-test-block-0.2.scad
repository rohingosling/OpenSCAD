...
//
// - Version 1.2
//   Updated some default parameters to give the model slightly more consistant default settings.
//   * Updated the default width, height and length of the cuboid, from 10mm to 20mm.
//   * Set the default bore x, y and z diameter, to 10mm.
//
// - Version 1.1
